...
baseModel = MobileNet(include_top=False, input_shape=(224, 224, 3))
...
model.save("mobileNet.h5") # tensorflowjs_converter --input_format keras --output_format=tfjs_graph_model mm.h5 ../web/static/model/
