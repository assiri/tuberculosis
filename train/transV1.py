...
baseModel  = MobileNet(include_top=False, input_shape=(224, 224, 3), alpha=1.0, depth_multiplier=1)
...
model.save("mmv1.h5") # tensorflowjs_converter --input_format keras --output_format=tfjs_graph_model mmv1.h5 ../web/static/model1/
